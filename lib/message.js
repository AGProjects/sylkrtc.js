...
const PARSED_CONTENT_TYPES = new Set(['application/sylk-file-transfer', 'application/sylk-message-metadata']);
...
class Message extends EventEmitter {
    constructor(message, identity, state = null) {
        ...
        if (PARSED_CONTENT_TYPES.has(this._contentType)) {
            try {
                this._json = JSON.parse(message.content, utils.parseDates);

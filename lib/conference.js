...
class Participant extends EventEmitter {
    ...
    _handleOffer(offerSdp) {
        ...
        const pc = new rtcninja.RTCPeerConnection(pcConfig);
        pc.onaddstream = (event, stream) => {
            DEBUG('Stream added');
        ...
        pc.setRemoteDescription(
            new rtcninja.RTCSessionDescription({type: 'offer', sdp: offerSdp}),
            // success
            () => {

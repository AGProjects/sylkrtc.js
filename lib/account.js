...
import { Call, Identity } from './call';
    ...
    _handleEvent(message) {
        ...
        switch (message.event) {
            ...
            case 'incoming_session':
                ...
                let mediaTypes = { audio: false, video: false };
                ...
                break;
            case 'missed_session':
                data.originator = new Identity(message.data.originator.uri, message.data.originator.display_name);

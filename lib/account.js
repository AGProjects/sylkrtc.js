...
class Account extends EventEmitter {
    ...
    sendMessage(uri, message, contentType = 'text/plain', options = {}, cb = null) {
        ...
        (async () => {
            ...
            let result = {};
            if (this._pgp !== null && !options.cleartext && contentType !== 'text/pgp-private-key' && contentType !== 'text/pgp-public-key') {
    ...
    removeMessage(message, cb = null) {
        ...
        const ids = message.chunkIds.length > 0 ? message.chunkIds : [message.id];
                ...
                (async () => {
                    if (this._pgp !== null) {
                        ...
                        for (const [idx, messageEntry] of message.messages.entries()) {
                            ...
                            } else if (locationSharing.isLocationSharing(messageEntry.content_type)) {

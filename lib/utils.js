...
class SharedFile {
    constructor(uploader, uploader_session, filename) {
        this._uploader = uploader;
        this._uploader_session = uploader_session;
...
export default { Identity, SharedFile, createLocalSdp, mungeSdp, getMediaDirections, attachMediaStream, closeMediaStream};
